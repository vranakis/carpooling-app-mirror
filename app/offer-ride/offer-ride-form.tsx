...
export default function OfferRideForm({ userId }: OfferRideFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log("Submitting ride form for user:", userId);

      // Pass userId to the server action
      const result = await createRide(userId, formData);
